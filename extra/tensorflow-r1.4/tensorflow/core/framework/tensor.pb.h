...
class VariantTensorDataProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.VariantTensorDataProto) */ {
 public:
  ...
  static const VariantTensorDataProto* internal_default_instance();
  ...
  inline VariantTensorDataProto* New() const { return New(NULL); }

  VariantTensorDataProto* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void UnsafeMergeFrom(const VariantTensorDataProto& from);
  protected:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<VariantTensorDataProto> VariantTensorDataProto_default_instance_;
