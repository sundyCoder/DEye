...
class ResourceHandleProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.ResourceHandleProto) */ {
 public:
  ...
  static const ResourceHandleProto* internal_default_instance();
  ...
  void UnsafeMergeFrom(const ResourceHandleProto& from);
  protected:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<ResourceHandleProto> ResourceHandleProto_default_instance_;
