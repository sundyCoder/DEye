...
void protobuf_AssignDesc_tensorflow_2fcore_2fframework_2ftensor_2eproto() {
  ...
  static const int TensorProto_offsets_[15] = {
  ...
  VariantTensorDataProto_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      VariantTensorDataProto::internal_default_instance(),
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      VariantTensorDataProto_descriptor_, VariantTensorDataProto::internal_default_instance());
}
...
void protobuf_ShutdownFile_tensorflow_2fcore_2fframework_2ftensor_2eproto() {
  ...
  VariantTensorDataProto_default_instance_.Shutdown();
...
void protobuf_InitDefaults_tensorflow_2fcore_2fframework_2ftensor_2eproto_impl() {
  ...
  ::google::protobuf::internal::GetEmptyString();
  VariantTensorDataProto_default_instance_.DefaultConstruct();
  TensorProto_default_instance_.get_mutable()->InitAsDefaultInstance();
  VariantTensorDataProto_default_instance_.get_mutable()->InitAsDefaultInstance();
}
...
void protobuf_AddDesc_tensorflow_2fcore_2fframework_2ftensor_2eproto_impl() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "TensorProtosP\001\370\001\001b\006proto3", 825);
...
::google::protobuf::internal::ExplicitlyConstructed<VariantTensorDataProto> VariantTensorDataProto_default_instance_;
...
void VariantTensorDataProto::UnsafeMergeFrom(const VariantTensorDataProto& from) {
  GOOGLE_DCHECK(&from != this);
...
inline const VariantTensorDataProto* VariantTensorDataProto::internal_default_instance() {
  return &VariantTensorDataProto_default_instance_.get();
}
#endif  // PROTOBUF_INLINE_NOT_IN_HEADERS
