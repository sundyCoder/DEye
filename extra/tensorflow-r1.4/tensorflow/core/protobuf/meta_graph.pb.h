...
class TensorInfo_CooSparse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.TensorInfo.CooSparse) */ {
 public:
  ...
  static const TensorInfo_CooSparse* internal_default_instance();
  ...
  void UnsafeMergeFrom(const TensorInfo_CooSparse& from);
  protected:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<TensorInfo_CooSparse> TensorInfo_CooSparse_default_instance_;
